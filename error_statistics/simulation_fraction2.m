function [k_segment,std_k2,pro2d_k2,nfail2,pct95_2d,pct99_2d] = ...
    simulation_fraction2(npts,ko3d,conditions)
...
%     pct99_3d = 0;
%     pct99_2d = 0;
    [std_dev2,ab_dev2,numberfail2,prct95_2d,prct99_2d] = simulation_segment2(j0,so3d,conditions); 
