function [extentx extentv]=near_range2d(jx,runlength,n_lag,r3d)
...
min3d=[min(r3d(starti:jx-n_lag-1,1)) min(r3d(starti:jx-n_lag-1,2))];
max3d=[max(r3d(starti:jx-n_lag-1,1)) max(r3d(starti:jx-n_lag-1,2))];
...
extentx=[max3d(1)-min3d(1) max3d(2)-min3d(2)]; 
